...
$timezone = new \DateTimeZone(date_default_timezone_get());
	...
	public function bot_id_to_quotation()
	{
		...
		$html.='<ul id="occupation" class="click-select  OccupationInputClass position-relative form-control main-control from-main selectpicker question_select_second question_select_second_1 occupation_add" data-live-search="true">
						  ...
						  <div class="col-12 overflow-auto border rounded min-selectbox d-none" style="position:absolute; top:36px; left:-1px; background:white; min-height:50px; max-height:250px;">
						  <li class="dropdown-item second-li rounded d-flex align-items-center p-3" value="0">No Jump</li>
                                <li class="dropdown-item second-li rounded d-flex align-items-center p-3" value="100">End Of conversion</li>';
