    ...
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            ...
            <div class="form-check form-switch mb-5">
                ...
                <label class="form-check-label" for="rtl-mode-switch"><?php //echo lang('Files.RTL Mode') ?></label>
            </div>
            ...
            <div class="form-check form-switch mb-5">
                ...
                <label class="form-check-label" for="dark-rtl-mode-switch"><?php //echo  lang('Files.Dark RTL Mode') ?></label>
            </div> 
            -->
