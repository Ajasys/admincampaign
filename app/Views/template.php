...
<div class="main-dashbord p-2">
    <div class="container-fluid p-0">
        ...
        <div class="p-2 bg-white rounded-2 mx-2 mb-2">
            <ul class="nav nav-pills navtab_primary_sm " id="pills-tab" role="tablist">
                <!-- <li class="nav-item" role="presentation">
                    <button class="nav-link active btn nav_btn" id="user_alert_tab" data-bs-toggle="pill"
                        data-bs-target="#user_alert" data-table="whatsapp_template" type="button" role="tab"
                        aria-controls="user_alert" aria-selected="true">Whatsapp</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link btn nav_btn" id="inquiry_alert_tab" data-bs-toggle="pill"
                        data-bs-target="#inquiry_alert" data-table="smstemplate" type="button" role="tab"
                        aria-controls="inquiry_alert" aria-selected="false">SMS</button>
                </li> -->
                <li class="nav-item" role="presentation">
        ...
        <div class="tab-content p-0" id="pills-tabContentS">
            ...
            <div class="tab-pane fade" id="inquiry_alert" role="tabpanel" aria-labelledby="inquiry_alert_tab"
                tabindex="0">
                <!-- <div class="container-fluid p-0 main-check-class">
                    <div class="p-2">
                        <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="px-3 py-2 bg-white rounded-2 mx-2 mb-2">
                        <table id="email_table" class="email-tamplate comman_list_data_table w-100 table main-table">
                            <thead>
                                <tr>
                                    <th>
                                        <input class="select-all-sms check_box emailQuery" type="checkbox"
                                            id="select-all-sms">
                                    </th>
                                    <th>
