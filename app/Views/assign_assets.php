        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <select id="user" name="user" class="selectpicker form-control form-main pt-3"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary assign_asset assign_asset_load" data-bs-toggle="modal"
                        data-bs-target="#assign_asset">Next</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <butto type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        onclick="reloadPage()"></butto>
                </div>
                <div class="modal-body m-0 p-0">
                    ...
                    <div class="p-2">
                        <div class="col-12 d-flex flex-wrap">
                            <!-- first-div -->
                            <div class="d-lg-block col-12 col-sm-12 col-md-12 col-lg-6 col-xl-3 col-xxl-3 social-accounts main-box rounded-bottom-0"
                                style="height:80vh">
                                <div class="col-12 border rounded-3 bg-white position-lg-relative rounded-bottom-0"
                                    style="height:80vh">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed m-0 p-2" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                                    aria-expanded="true" aria-controls="collapseOne">
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="30px"
                                                        height="30px" x="0" y="0" viewBox="0 0 512 512"
                                                    ...
                                                    <div class="accordion-body p-0">
                                                        <div class="accordion" id="accordionExample_two">
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="collapseOne_in" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed m-0 p-2" type="button"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="30px"
                                                        height="30px" x="0" y="0" viewBox="0 0 176 176"
                                                        style="enable-background:new 0 0 512 512" xml:space="preserve"
                                                        class="">
                                                        <g>
                                                            <g data-name="Layer 2">
                            ...
                            <div class="d-lg-block col-12 col-sm-12 col-md-12 col-lg-6 col-xl-3 col-xxl-3  social-accounts main-box rounded-bottom-0"
                                ...
                                <div class="col-12 border rounded-3 bg-white position-lg-relative rounded-bottom-0"
                                    ...
                                    <div class="instagram_div_to d-none">
                                        ...
                                        <div
                                            class="cursor-pointer ps-3 account-box d-flex  flex-wrap  border-bottom alihgn-items-center">
                                            <div class="d-flex align-items-center" style="height: 45px;">
                                                <input type="checkbox" id="selectall"
                                                    class="me-2 rounded-3 select_all_checkbox"
                            ...
                            <div class="d-none col-12 col-sm-12 col-md-12 col-lg-6 d-xl-block col-xxl-6 transcript_box  main-box rounded-bottom-0"
                                ...
                                <div class="col-12 border rounded-end-4 bg-white position-relative SetChatBackGroundClass rounded-3 overflow-hidden rounded-bottom-0"
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-1">
                                                        <label class="switch_toggle_primary">
                                                            <input
                                                                ...
                                                                type="checkbox" value="create_scenarios">
                                                    ...
                                                    <div class="col-1">
                                                        <label class="switch_toggle_primary">
                                                            <input
                                                                ...
                                                                type="checkbox" value="post_comments">
                                                            <span class="check_input_primary round"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-11">
                                        ...
                                        <!-- instagram -->
                                        <div class="instagram_div_to d-non col-12 overflow-y-scroll"
                                            style="height:90vh;">
                                            <div>
                                                <div class="col-12 p-2 d-flex align-items-center">
                                                    <div class="col-1">
                                                        <label class="switch_toggle_primary">
                                                            <input class="toggle-checkbox fs-3 on_off_btn_Desktop"
                                                                type="checkbox">
                                                            <span class="check_input_primary round"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-11">
                                                        ...
                                                        <p class="ms-3">Create, manage or delete posts, stories and more
                                                            as the Instagram account. View posts from other Instagram
                                                            accounts that this account follows.</p>
                                                    </div>
                                                </div>
                                                <div class="col-12 p-2 d-flex align-items-center">
                                                    <div class="col-1">
                                                ...
                                                <div class="col-12 p-2 d-flex align-items-center">
                                                    ...
                                                    <div class="col-11">
                                                        ...
                                                        <p class="ms-3">Review and respond to comments, remove unwanted
                                                            content and report activity.</p>
                                                    </div>
                                                </div>
                                                <div class="col-12 p-2 d-flex align-items-center">
                                                    <div class="col-1">
                                                    ...
                                                    <div class="col-11">
                                                        ...
                                                        <p class="ms-3">Create, manage and delete ads for the Instagram
                                                            account.</p>
                                                    </div>
                                                </div>
                                                <div class="col-12 p-2 d-flex align-items-center">
                                                    ...
                                                    <div class="col-11">
                                                        ...
                                                        <p class="ms-3">See how the Instagram account, content and ads
                                                            perform.</p>
                                                    </div>
                                                </div>
                                            </div>
