    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fa-solid fa-repeat"></i> Syncronice With Facebook A/c</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="col-12">
                <small>Select facebook account and syncronice with instagram account.</small>
                    <div class="main-selectpicker pt-3">
                        <select class="selectpicker form-control form-main" aria-label="Default select example">
                            <option>Select Account</option>
                            <?php
                            if (isset($conn_rows)) {
                                foreach ($conn_rows as $type_key => $user_value) {
                                    echo '<option class="dropdown-item" value="' . $user_value["id"] . '" >' . $user_value["fb_app_name"] . '</option>';
                                }
                            }
                            ?>
                        </select>
