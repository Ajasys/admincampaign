...
<div class="main-dashbord p-2 ">
    <div class="container-fluid p-0">
        ...
        <!-- add model -->
        <div class="modal fade modal-lg show" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="col-6">
                                ...
                                <div class="col-12 mb-3 ">
                                    <div class="main-selectpicker">
                                        <select class="selectpicker form-control main-control language_div" id="language" name="language" required>
                                            ...
                                            <option class=" dropdown-item " value="en_US" ng-repeat="lang in template_lang">English US (en_US)</option>
                                            ...
                                            <option class=" dropdown-item " value="zh_CN" ng-repeat="lang in template_lang">Chinese (CHN)</option>

                                            <option class=" dropdown-item " value="zh_HK" ng-repeat="lang in template_lang">Chinese (HKG)</option>

                                            <option class=" dropdown-item " value="zh_TW" ng-repeat="lang in template_lang">Chinese (TAI)</option>
                                            ...
                                            <option class=" dropdown-item " value="en_GB" ng-repeat="lang in template_lang">English (UK)</option>
                                            ...
                                            <option class=" dropdown-item " value="pt_BR" ng-repeat="lang in template_lang">Portuguese (BR)</option>

                                            <option class=" dropdown-item " value="pt_PT" ng-repeat="lang in template_lang">Portuguese (POR)</option>
                                            ...
                                            <option class=" dropdown-item " value="es_AR" ng-repeat="lang in template_lang">Spanish (ARG)</option>

                                            <option class=" dropdown-item " value="es_ES" ng-repeat="lang in template_lang">Spanish (SPA)</option>

                                            <option class=" dropdown-item " value="es_MX" ng-repeat="lang in template_lang">Spanish (MEX)</option>
                            ...
                            <div id="selectedImageName"></div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="main-selectpicker">
                                        <select class="selectpicker form-control main-control header_div" id="Button" name="Button" ng-model="selectedHeader" ng-change="handleHeaderChange()" required>
        ...
        <script>
            ...
            // });   
            $('body').on('Change', '.Template_header1', function() {
                // var a = $(this).val();


                if ($(this).val() === 'TEXT') {
                    $(this).closest('.header-jqury').children('.file_upload').addClass('d-none');
                    $(this).closest('.header-jqury').children('.text-comment').removeClass('d-none');

                    alert($("#Template_header").html());
                }
            })
            // alert($("#Template_header").val());
        </script>
