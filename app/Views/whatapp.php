            ...
            <div class="col p-1">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade " id="pills-ex-view-tab" role="tabpanel" aria-labelledby="pills-ex-view"
                        tabindex="0">
                        <div
                            class="col-12 bg-white border rounded-3 px-4 py-3 d-flex justify-content-between align-items-center mt-3">
                            ...
                            <form class="needs-validation membershipDiv" name="whatsapp_template_add_edit" method="POST"
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 my-3">
                                        ...
                                        <span class="btn btn-primary ButtonVariableClass" id=""><i class="fa fa-plus"
                                                aria-hidden="true"></i>&nbsp; Add button</span>
