    ...
    <div class="container-fluid p-0">
        <div class="col-12 p-2 d-flex flex-wrap">
            <div class="p-1 first-container slide-toggle">
                <div class="col-12 bg-white border rounded-3 px-4 py-3 d-flex flex-wrap">
                        ...
                        <ul class=" d-flex  flex-wrap nav nav-pills navtab_primary_sm" id="pills-tab" role="tablist">
                            ...
                            <li class="col-12 d-flex my-2 flex-wrap active p-2 rounded-3 border border-light-subtle menu-toggle bg-body-secondary nav-item Tab1Class"
                                ...
                                <div class="col-12 d-flex" DataStatus='1' data-table="exercise_type"
                                    data-bs-toggle="pill" data-bs-target="#pills-ex-single-tab" type="button" role="tab"
                                    aria-controls="#pills-ex-single-tab" aria-selected="true">
                                    <p>
                            ...
                            <li class="col-12 d-flex my-2 flex-wrap active p-2 rounded-3 ViewSendMEssageDataTab border border-light-subtle menu-toggle nav-item Tab2Class"
                                ...
                                <div class="col-12 d-flex" DataStatus='1' data-table="exercise_type"
                                    ...
                                    aria-controls="pills-ex-view-tab" aria-selected="false">
                            ...
                            <li class="col-12 d-flex my-2 flex-wrap active p-2 rounded-3 border border-light-subtle menu-toggle nav-item Tab3Class"
                                role="presentation">
                                <div class="col-12 d-flex" DataStatus='1' data-table="exercise_type"
                                    data-bs-toggle="pill" data-bs-target="#pills-ex-schedule-tab3" type="button"
                                    role="tab" aria-controls="pills-ex-schedule-tab3" aria-selected="false">
                                    <p><svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25" x="0"
                                            y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512"
                                            xml:space="preserve" class="">
                                            <g>
                                                <path
                                                    d="M391.474 0v72.894h72.489C435.664 44.594 419.692 28.218 391.474 0z"
                    ...
                    <div class="col-12 mt-2 d-flex justify-content-end">
                        <div class="col-1 p-3 Arro-pro " style="cursor:pointer"><i
                                class="bi bi-arrow-left Arrowmovement text-primary fw-bold fs-5"></i></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg p-1">
                                                            ...
                                                            <div class="modal-body-card pb-1">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="col-12 mb-3 mt-2">
                                                                        <select
                                                                            class="form-control main-control templatesnamelistddclass header_div"
                                                                    ...
                                                                    <div
                                                                        class="modal-footer justify-content-center mt-2 col-12 text-center">
                                                                    ...
                                                                    <div class="col-12 pt-3 border-top mb-2 text-end">
                                                                        <span class="btn-primary Template_send"
                                                                            ...
                                                                            value="memberships_update1">Send</sp>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="preview-chat-section mobile-whatapp" style="border:10px solid #9a9a9a;">
                                                            <div class="preview-header-main-cont">
                                                                ...
                                                                <div class="preview-header-text">
                                                                    <span
                                                                        class="company-name user ng-binding">appo</span>
                                                                </div>
                                                            ...
                                                            <div
                                                                class="preview-chat-section-chat overflow-y-scroll mobile-whatapp-body">
                                                                ...
                                                                <div class="single-t-call-button">
                                                                    <button
                                                                        class="single-button-whatsapp-template word-wrap">Ok</button>
                                                                    <button
                                                                        class="single-button-whatsapp-template13 word-wrap"
                                                                ...
                                                                <div class="preview-whatsapp-footer">
                                                                    <div
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            ng-disabled="true" aria-disabled="true"
                                                                            disabled="disabled">
                ...
                <!-- shedual modal -->
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show " id="pills-ex-schedule-tab" role="tabpanel"
                        aria-labelledby="pills-ex-schedule" tabindex="0">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body-secondery justify-content-center">
                                                            <div class="modal-body-card justify-content-center">
                                                                <label
                                                                    class=" pull-left full-width text-left m-b-15"><b>Note:
                                                                    </b> follow <a
                                                                        href="<?php echo base_url('/assets/sample.csv'); ?>"
                                                                        download='sample.csv' target="_blank">csv</a>
                                                                    format for
                                                                    reference</label>


                                                                <div class="col-12 mb-3 justify-content-center mt-2">
                                                                    <a href="<?php echo base_url('/assets/sample.csv'); ?>"
                                                                        download='sample.csv'
                                                                        class="text-secondary mx-1 mb-1 add_property_js add_user_role_css add_user-role-pdf">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            ...
                                                                            <g>
                                                                                <path
                                                                                    d="M496 432.011H272c-8.832 0-16-7.168-16-16v-320c0-8.832 7.168-16 16-16h224c8.832 0 16 7.168 16 16v320c0 8.832-7.168 16-16 16z"
                                                                                    style="" fill="#eceff1"
                                                                                    data-original="#eceff1"></path>
                                                                                <path
                                                                                    d="M336 176.011h-64c-8.832 0-16-7.168-16-16s7.168-16 16-16h64c8.832 0 16 7.168 16 16s-7.168 16-16 16zM336 240.011h-64c-8.832 0-16-7.168-16-16s7.168-16 16-16h64c8.832 0 16 7.168 16 16s-7.168 16-16 16zM336 304.011h-64c-8.832 0-16-7.168-16-16s7.168-16 16-16h64c8.832 0 16 7.168 16 16s-7.168 16-16 16zM336 368.011h-64c-8.832 0-16-7.168-16-16s7.168-16 16-16h64c8.832 0 16 7.168 16 16s-7.168 16-16 16zM432 176.011h-32c-8.832 0-16-7.168-16-16s7.168-16 16-16h32c8.832 0 16 7.168 16 16s-7.168 16-16 16zM432 240.011h-32c-8.832 0-16-7.168-16-16s7.168-16 16-16h32c8.832 0 16 7.168 16 16s-7.168 16-16 16zM432 304.011h-32c-8.832 0-16-7.168-16-16s7.168-16 16-16h32c8.832 0 16 7.168 16 16s-7.168 16-16 16zM432 368.011h-32c-8.832 0-16-7.168-16-16s7.168-16 16-16h32c8.832 0 16 7.168 16 16s-7.168 16-16 16z"
                                                                                    style="" fill="#388e3c"
                                                                                    data-original="#388e3c"></path>
                                                                                <path
                                                                                    ...
                                                                                    style="" fill="#2e7d32"
                                                                                    data-original="#2e7d32" class="">
                                                                                </path>
                                                                                <path
                                                                                    d="m220.032 309.483-50.592-57.824 51.168-65.792c5.44-6.976 4.16-17.024-2.784-22.464-6.944-5.44-16.992-4.16-22.464 2.784l-47.392 60.928-39.936-45.632c-5.856-6.72-15.968-7.328-22.56-1.504-6.656 5.824-7.328 15.936-1.504 22.56l44 50.304-44.608 57.344c-5.44 6.976-4.16 17.024 2.784 22.464a16.104 16.104 0 0 0 9.856 3.36c4.768 0 9.472-2.112 12.64-6.176l40.8-52.48 46.528 53.152A15.874 15.874 0 0 0 208 336.011c3.744 0 7.488-1.312 10.528-3.968 6.656-5.824 7.328-15.936 1.504-22.56z"
                                                                                    style="" fill="#fafafa"
                                                                ...
                                                                <div class="col-12 mb-3">
                                                                    <input type="text"
                                                                        class="form-control main-control campaign_name_div"
                                                                        id="campaign_name"
                                                                        placeholder="campaign name..." name="" required>
                                                                </div>
                                                                <div class=" col-6 mb-3 ">
                                                                    <input type="text" name="" id="fromDate_edit"
                                                                        class="date-picker form-control main-control "
                                                                        placeholder="DD-MM-YYYY">
                                                                </div>
                                                                <div class="col-6 mb-3">
                                                                    <input type="text" name="daily_time" id="daily_time"
                                                                        class="form-control main-control dailyinputfields daily-time"
                                                    ...
                                                    <div class="preview-chat-section">
                                                        ...
                                                        <div class="preview-chat-section-chat overflow-y-scroll">
                                                            ...
                                                            <div class="preview-chat-paragraph bg-white p-3 col-7">
                                                                <p
                                                                    class="single-t-user-chat user msg fs-16 m-0 p-l-10 p-r-5 word-wrap">
                                                                    Message Header Section</p>
                                                                <p contenteditable="false"
                                                                    class="word-wrap single-t-text-chat message msg m-0 p-l-10 p-r-5 BodyValue"
                                                                    id="bodytextvalue">
                                                                    Message Body Section</p>
                                                            ...
                                                            <div class="single-t-call-button">
                                                                <button
                                                                    class="single-button-whatsapp-template word-wrap">Ok</button>
                                                                <button
                                                                    class="single-button-whatsapp-template word-wrap">Cancel</button>
                                                            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade " id="pills-ex-schedule-tab3" role="tabpanel"
                        aria-labelledby="pills-ex-schedule" tabindex="0">
                        <div class="col-12 bg-white border rounded-3 px-4 py-3 d-flex flex-wrap ">
                            <div class="col-12 d-flex flex-wrap my-2 justify-content-between">
                                ...
                                <div class=" d-flex align-items-center">
                                    <div class="input-group">
                                        <input type="text" class="form-control MasterListDataSearchBar"
                                            placeholder="Search Name" aria-label="Recipient's username"
                                            aria-describedby="button-addon2">
                                        <button class="btn btn-outline-secondary border MasterListDataSearchBarButton"
                                ...
                                <div class=" d-flex flex-wrap align-items-center justify-content-end col-2 ">
                                    ...
                                    <div class="col-3 px-2">
                                        <button class="btn-primary-rounded" id="template_data" data-bs-toggle="modal"
                                    ...
                                    <table id="memberships_table"
                                        ...
                                        <thead>
                                            <tr class="th-header-noborder">
                                                <th class="template-creation-heading">Name <i
                                                        class="fa fa-sort p-l-10 d-none"
                ...
                <div class="tab-content">
                    <div class="tab-pane fade " id="pills-ex-view-tab" role="tabpanel" aria-labelledby="pills-ex-view"
                        tabindex="0">
                        <div class="col-12 bg-white border rounded-3 px-4 py-2">
                            <div
                                class="col-12 bg-white  rounded-3  py-2 d-flex justify-content-lg-between align-items-center flex-wrap">
                                <div class="">
                                    <div class="input-group me-5 my-2 my-lg-0">
                                        <input type="text" name="phone" class="form-control FilterPhoneNumber"
                                            placeholder="Phone....">
                                ...
                                <div class="">
                                    <div class="input-group me-5 my-2 my-lg-0">
                                        <input type="text" name="select-date"
                                            class="FilterDatePicker form-control FilterDate" placeholder="Select Date">
                                        <button class="btn btn-light FilterDatePicker border"><i
                                                class="fa-regular fa-calendar-days"></i></button>
                                    </div>
                                </div>
                                <div class="">
                                    <select name="Templates"
                                        class="form-select me-5 templatesnamelistddclass FilterTemplateName my-2 my-lg-0">
                                ...
                                <div class="">
                                    <div class="my-2 my-lg-0">
                                        <button class="btn-primary-rounded refresh-btn mx-2 FilterClearAll"><i
                                                class="bi bi-x-lg fs-14"></i></button>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="my-2 my-lg-0">
                                        <button class="btn-primary-rounded refresh-btn"><i
                                                class="fa-solid fa-rotate-right RefreshBtnConversation fs-14 "></i></button>
                                ...
                                <form class="needs-validation membershipDiv" name="whatsapp_template_add_edit"
                                    ...
                                    <div class="col-12 mb-3 ">
                                        ...
                                        <input type="text"
                                            ...
                                            id="Template_nameId" placeholder="Template name" name="Template_name"
                                            required>
                                        <p class="CheckTemplateNameAlertPTag text-danger fs-12" style="display:none;">
                                            Name
                                            can
                                    ...
                                    <div class="col-12 mb-3 ">
                                        ...
                                        <div class="main-selectpicker">
                                            ...
                                            <select
                                                class="form-control main-control TemplateLanguageDDList language_div"
                                                id="languageid" name="language" required>
                                                <option class="fs-12" label="Please select your language" value="">
                                                ...
                                                <option class="fs-12 ng-binding ng-scope" value="en"
                                                    ng-repeat="lang in template_lang">English (en)</option>

                                                <option class="fs-12 ng-binding ng-scope" value="af"
                                                    ng-repeat="lang in template_lang">Afrikaans</option>
                                                <option class="fs-12 ng-binding ng-scope" value="sq"
                                                    ng-repeat="lang in template_lang">Albanian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ar"
                                                    ng-repeat="lang in template_lang">Arabic</option>
                                                <option class="fs-12 ng-binding ng-scope" value="az"
                                                    ng-repeat="lang in template_lang">Azerbaijani</option>
                                                <option class="fs-12 ng-binding ng-scope" value="bn"
                                                    ng-repeat="lang in template_lang">Bengali</option>
                                                <option class="fs-12 ng-binding ng-scope" value="bg"
                                                    ng-repeat="lang in template_lang">Bulgarian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ca"
                                                    ng-repeat="lang in template_lang">Catalan</option>
                                                ...
                                                <option class="fs-12 ng-binding ng-scope" value="hr"
                                                    ng-repeat="lang in template_lang">Croatian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="cs"
                                                    ng-repeat="lang in template_lang">Czech</option>
                                                <option class="fs-12 ng-binding ng-scope" value="da"
                                                    ng-repeat="lang in template_lang">Danish</option>
                                                <option class="fs-12 ng-binding ng-scope" value="nl"
                                                    ng-repeat="lang in template_lang">Dutch</option>
                                                <option class="fs-12 ng-binding ng-scope" value="en_GB"
                                                    ng-repeat="lang in template_lang">English (UK)</option>
                                                <option class="fs-12 ng-binding ng-scope" value="et"
                                                    ng-repeat="lang in template_lang">Estonian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="fil"
                                                    ng-repeat="lang in template_lang">Filipino</option>
                                                <option class="fs-12 ng-binding ng-scope" value="fi"
                                                    ng-repeat="lang in template_lang">Finnish</option>
                                                <option class="fs-12 ng-binding ng-scope" value="fr"
                                                    ng-repeat="lang in template_lang">French</option>
                                                <option class="fs-12 ng-binding ng-scope" value="de"
                                                    ng-repeat="lang in template_lang">German</option>
                                                <option class="fs-12 ng-binding ng-scope" value="el"
                                                    ng-repeat="lang in template_lang">Greek</option>
                                                <option class="fs-12 ng-binding ng-scope" value="gu"
                                                    ng-repeat="lang in template_lang">Gujarati</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ha"
                                                    ng-repeat="lang in template_lang">Hausa</option>
                                                <option class="fs-12 ng-binding ng-scope" value="he"
                                                    ng-repeat="lang in template_lang">Hebrew</option>
                                                <option class="fs-12 ng-binding ng-scope" value="hi"
                                                    ng-repeat="lang in template_lang">Hindi</option>
                                                <option class="fs-12 ng-binding ng-scope" value="hu"
                                                    ng-repeat="lang in template_lang">Hungarian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="id"
                                                    ng-repeat="lang in template_lang">Indonesian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ga"
                                                    ng-repeat="lang in template_lang">Irish</option>
                                                <option class="fs-12 ng-binding ng-scope" value="it"
                                                    ng-repeat="lang in template_lang">Italian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ja"
                                                    ng-repeat="lang in template_lang">Japanese</option>
                                                <option class="fs-12 ng-binding ng-scope" value="kn"
                                                    ng-repeat="lang in template_lang">Kannada</option>
                                                <option class="fs-12 ng-binding ng-scope" value="kk"
                                                    ng-repeat="lang in template_lang">Kazakh</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ko"
                                                    ng-repeat="lang in template_lang">Korean</option>
                                                <option class="fs-12 ng-binding ng-scope" value="lo"
                                                    ng-repeat="lang in template_lang">Lao</option>
                                                <option class="fs-12 ng-binding ng-scope" value="lv"
                                                    ng-repeat="lang in template_lang">Latvian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="lt"
                                                    ng-repeat="lang in template_lang">Lithuanian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="mk"
                                                    ng-repeat="lang in template_lang">Macedonian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ms"
                                                    ng-repeat="lang in template_lang">Malay</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ml"
                                                    ng-repeat="lang in template_lang">Malayalam</option>
                                                <option class="fs-12 ng-binding ng-scope" value="mr"
                                                    ng-repeat="lang in template_lang">Marathi</option>
                                                <option class="fs-12 ng-binding ng-scope" value="nb"
                                                    ng-repeat="lang in template_lang">Norwegian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="fa"
                                                    ng-repeat="lang in template_lang">Persian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="pl"
                                                    ng-repeat="lang in template_lang">Polish</option>
                                                ...
                                                <option class="fs-12 ng-binding ng-scope" value="pa"
                                                    ng-repeat="lang in template_lang">Punjabi</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ro"
                                                    ng-repeat="lang in template_lang">Romanian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ru"
                                                    ng-repeat="lang in template_lang">Russian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="sr"
                                                    ng-repeat="lang in template_lang">Serbian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="sk"
                                                    ng-repeat="lang in template_lang">Slovak</option>
                                                <option class="fs-12 ng-binding ng-scope" value="sl"
                                                    ng-repeat="lang in template_lang">Slovenian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="es"
                                                    ng-repeat="lang in template_lang">Spanish</option>
                                                ...
                                                <option class="fs-12 ng-binding ng-scope" value="sw"
                                                    ng-repeat="lang in template_lang">Swahili</option>
                                                <option class="fs-12 ng-binding ng-scope" value="sv"
                                                    ng-repeat="lang in template_lang">Swedish</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ta"
                                                    ng-repeat="lang in template_lang">Tamil</option>
                                                <option class="fs-12 ng-binding ng-scope" value="te"
                                                    ng-repeat="lang in template_lang">Telugu</option>
                                                <option class="fs-12 ng-binding ng-scope" value="th"
                                                    ng-repeat="lang in template_lang">Thai</option>
                                                <option class="fs-12 ng-binding ng-scope" value="tr"
                                                    ng-repeat="lang in template_lang">Turkish</option>
                                                <option class="fs-12 ng-binding ng-scope" value="uk"
                                                    ng-repeat="lang in template_lang">Ukrainian</option>
                                                <option class="fs-12 ng-binding ng-scope" value="ur"
                                                    ng-repeat="lang in template_lang">Urdu</option>
                                                <option class="fs-12 ng-binding ng-scope" value="uz"
                                                    ng-repeat="lang in template_lang">Uzbek</option>
                                                <option class="fs-12 ng-binding ng-scope" value="vi"
                                                    ng-repeat="lang in template_lang">Vietnamese</option>
                                                <option class="fs-12 ng-binding ng-scope" value="zu"
                                                    ng-repeat="lang in template_lang">Zulu</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="form-memberships" class="main-label fw-medium">BODY<sup
                                                class="validationn">*</sup></label>
                                        <textarea class="form-control main-control TemplateBodyClass body_div"
                                            id="body_id" placeholder="Type Your Body Text Here..." name=""
                                            required></textarea>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="col-12 ">
                                            ...
                                            <div class="main-selectpicker">
                                                <select
                                                    ...
                                                    id="Button_make_picker" name="Button" ng-model="selectedHeader"
                                                    ng-change="handleHeaderChange()" required>
                                        ...
                                        <div class="col-12 my-3">
                                            ...
                                            <span class="btn btn-primary ButtonVariableClass" id=""><i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                                ...
                                <div class="preview-chat-section rounded-0">
                                    ...
                                    <div class="preview-chat-section-chat overflow-y-scroll">
                                        <div class="preview-chat-paragraph bg-white p-3 col-10">
                                            ...
                                            <img class="rounded-3 preview-header-paragraphVIDEO" src=""
                                                style="width:150px;height:150px;object-fit: contain;">
                                            <!-- <div class="preview-header-paragraph" ng-if="submitParamDetails"
                                            class="ng-scope" style="">
                                            <div ng-if="media_footer_text.length > 0 "
                                        ...
                                        <div class="preview-whatsapp-footer">
                                            <div class="whatsapp-footer d-flex flex-wrap align-items-center">
                                                ...
                                                <i class="fa fa-smile-o whatsapp-footer-relative"
                                                    aria-hidden="true"></i>
                                                <input class="chat-btn-chat whatsapp-footer-1 col-7"
                                                    placeholder="Type a message" ng-disabled="true" aria-disabled="true"
                                                    disabled="disabled">
                                                <i class="fa fa-paperclip whatsapp-footer-2" aria-hidden="true"></i>
                                                <i class="fa fa-camera whatsapp-footer-3" aria-hidden="true"></i>
                                                <p class="audio-icon-tem"><i class="fa fa-microphone icon-tem-micro"
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn  btn-primary   Elbtn EditTemplateButtonClass" name="" id=""><i
