                                                ...
                                                if (isset($RecievedMessageArray['messages'][0]['type'])) {
                                                    ...
                                                    if ($responsemessage_type == 'text') {
                                                        if (isset($RecievedMessageArray['messages'][0]['context'])) {
                                                            $db_connection->query("INSERT INTO `" . $result_value['username'] . "_messages`(`contact_no`, `platform_account_id`, `message_status`, `created_at`,`conversation_id`, `platform_status`, `sent_date_time`, `message_type`, `sent_recieved_status`, `message_contant`, `replay_message_id`, `timestamp`, `msg_read_status`) VALUES ('" . $sendercontact . "', '" . $conversation_account_id . "','0', '" . gmdate('Y-m-d H:i:s') . "', '" . $RecievedMessageArray['messages'][0]['id'] . "', '1', '" . gmdate('Y-m-d H:i:s') . "', '2','2', '" . json_encode($RecievedMessageArray['messages'][0]['text']) . "', '" . $RecievedMessageArray['messages'][0]['context']['id'] . "', '" . $RecievedMessageArray['messages'][0]['timestamp'] . "', '1')");
                                                        } else {
                                                            $jsonString = json_encode($RecievedMessageArray['messages'][0]['text']);
                                                            $escapedJsonString = addslashes($jsonString);
                                                            $db_connection->query("INSERT INTO `" . $result_value['username'] . "_messages`(`contact_no`, `platform_account_id`, `message_status`, `created_at`,`conversation_id`, `platform_status`, `sent_date_time`, `message_type`, `sent_recieved_status`, `message_contant`, `timestamp`, `msg_read_status`) VALUES ('" . $sendercontact . "', '" . $conversation_account_id . "','0', '" . gmdate('Y-m-d H:i:s') . "', '" . $RecievedMessageArray['messages'][0]['id'] . "', '1', '" . gmdate('Y-m-d H:i:s') . "', '1','2', '" . $escapedJsonString . "', '" . $RecievedMessageArray['messages'][0]['timestamp'] . "')");
                                                            $db_connection->query("INSERT INTO `" . $result_value['username'] . "_notify_message`(`message`,`status`) VALUES ('" . $RecievedMessageArray['messages'][0]['text']['body'] . "','1', '1')");
                                                        }
                                                    ...
                                                    if ($QuestionValidation == '1') {
                                                        ...
                                                        if($QuestionType == '22'){
                                                            ...
                                                            $error_text = '';
                                                                ...
                                                                $BotQuestionDataRow = $BotQuestionData->num_rows;
                                                                $BotQuestionDataArray = $BotQuestionData->fetch_assoc();
                                                                writeToFile('! Step = 2 '. json_encode($BotQuestionDataArray));
                                                        ...
                                                        if (isset($RecievedMessageArray['messages'][0]['type'])) {
                                                            ...
                                                            if ($message_type == 'text') {
                                                                if (isset($RecievedMessageArray['messages'][0]['context'])) {
                                                                    ...
                                                                    $db_connection->query("INSERT INTO `admin_notify_message`(`message`,`status`) VALUES ('" . $RecievedMessageArray['messages'][0]['text']['body'] . "','1')");
                                                                }
