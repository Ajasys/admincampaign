...
<style>
     ...
     .chat-inner-box-img {
          /* background-image: url(https://admin.realtosmart.com/assets/images/chat-bg-img.svg); */
                              ...
                              <div class="chat-nav-search-bar p-3 border-bottom">
                                   <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                             ...
                                             <div class="chat-nav-search position-relative ms-3">
                                                  <input type="text" name="" id="searchbar"
                                                       class="form-control border rounded-pill py-1 pe-1 lh-lg text-body-secondary"
                                        ...
                                        <div class="dropdown d-flex align-items-center">
                                             ...
                                             <!-- <i class="bi bi-funnel filter_button"></i> -->
                                             <!-- </div> -->
                                             <a class=" btn-primary btn btn-submit clear_all_filter" id=""
                                                  style="display:none">Clear-All</a>
                                             <i class="fa-solid bi bi-funnel px-3 py-2 fs-6 m-2 rounded text-white cursor-pointer send_attachment_div"
                                                  id="chat_submit" message_user_id="" data-bs-target="#filter_model"
                              ...
                              <div class="main-chat-inner-box d-flex justify-content-between flex-column h-100">
                                   <div class="col-12 main-chat-header p-3 bg-white shadow-sm header_of_chat_div"
                                        ...
                                        <div class="d-flex justify-content-star align-items-center">
                                             ...
                                             <!-- <div class="chat-main-user d-flex justify-content-center align-items-center bg-opacity-75 bg-secondary rounded-circle">
                                             <img src="https://admin.realtosmart.com/assets/images/chat-user.svg" alt="" class="chatbox_profile_div chat-nav-user-img rounded-circle bg-secondary bg-opacity-75 overflow-hidden">
                                             </div> -->
                                             <div class="dropdown">
                                             ...
                                             <div class="dropdown ms-3 file-drop">
                                                  <a href="#" role="button" data-bs-toggle="dropdown"
                                                       class="three-dot-link-div" data-bs-auto-close="outside"
                                                       aria-expanded="false">
                                                       <i
                                                            class="bi bi-three-dots-vertical text-dark three-dot"></i>
                                                  </a>
                                                  <div class="dropdown-menu py-2 px-3 three-dot-link-div-model"
                                                       style="width: 300px;">
                                                       <label class="fw-medium text-nowrap file_attachment_div m-3"
                                                            href="" data-file-name="">Ticket-Status:</label>
                                                       <div class="d-flex align-items-center justify-content-between">
                                                            <div class="form-check">
                                                                 <input
                                                                      class="form-check-input ticket_status_check value_div"
                                                                      type="radio" name="ticket_status"
                                                                      id="flexRadioDefault1" value="New" value_id="1">
                                                            ...
                                                            <div class="form-check">
                                                                 <input
                                                                      class="form-check-input ticket_status_check value_div"
                                                                      type="radio" name="ticket_status"
                                                                      id="flexRadioDefault2" value="In Progress"
                                                                      value_id="2">
                                                                 <label class="form-check-label"
                                                            ...
                                                            <div class="form-check">
                                                                 <input
                                                                      class="form-check-input ticket_status_check value_div"
                                                                      type="radio" name="ticket_status"
                                                                      id="flexRadioDefault3" value="Closed"
                                                                      value_id="3">
                                                                 <label class="form-check-label"
                                                       ...
                                                       <div class="text-end"><button
                                                                 class="btn-primary-key rounded go_btn_class text-white fa-solid border-0 p-1 go_status_change_btn"
                                                                 chat_id="">Go</button></div>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-12 main-chat-input p-3 bg-white shadow-sm chat_input_div"
                                        ...
                                        <div class="d-flex justify-content-star align-items-center ">
                                             ...
                                             <!-- <i class="fa-solid bi bi-paperclip px-3 py-2 fs-6 rounded text-white cursor-pointer m-2" style="background-color:#724ebf !important"
                                             id="chat_submit" message_user_id=""></i> -->
...
<div class="modal fade  " id="filter_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog">
          <div class="modal-content">
               <div class="modal-header">
                    <h1 class="modal-title">Filter Model</h1>
                    <button type="button" class="btn-close btn-close-filter" data-bs-dismiss="modal"
                         aria-label="Close"></button>
               </div>
               <div class="modal-body modal-body-secondery">
                    <form class="filter_form_div">
                         <div class="modal-body-card">
                              <div class="col-12">
                                   <lable>User Name:</lable>
                                   <input class="form-control main-control  mt-2" type="text"
                                        placeholder="Enter User Name" name="name">
                              </div>
                              <div class="col-12 mt-2">
                                   <lable>User Id:</lable>
                                   <input class="form-control main-control mt-2" type="text" placeholder="Enter User ID"
                                        name="user_id">
                              </div>
                              <div class="col-12 mt-2">
                                   <lable>Ticket Status:</lable>
                              </div>
                              <div class="col-12 mt-2">
                                   <input type="checkbox" id="html" name="ticket_status_filter" value="New">
                                   <label for="html">New</label>
                              </div>
                              <div class="col-12 mt-2">
                                   <input type="checkbox" id="css" name="ticket_status_filter" value="In Progress">
                                   <label for="css">In Progress</label>
                              </div>
                              <div class="col-12 mt-2">
                                   <input type="checkbox" id="javascript" name="ticket_status_filter" value="Closed">
                                   <label for="javascript">Closed</label>
                              </div>
                         </div>
                    </form>
               </div>
               <div class="modal-footer">
                    <button type="button" class="btn-primary filter_save_btn">Save</button>
               </div>
          </div>
     </div>
</div>
...
<script>
     ...
     function list_data_s() {
          var form = $(".filter_form_div")[0];
          var formdata = new FormData(form);
          var arr = [];
          $.each($("input[name='ticket_status_filter']:checked"), function () {
               arr.push($(this).val());
          });
          formdata.append('table', 'master_support_ticket');
          formdata.append('all_ticket_status', arr);
          $.ajax({
               method: "post",
               url: "clint_list_data",
               data: formdata,
     ...
     $('body').on('click', '.click_event_div_list', function () {
          ...
          $(".change_name_chat_wise").text(user_name + "  [" + issue_title + "]");
...
<!-- <ul class="1-div ticket_status_ul">
                                                            <li class="m-2">
                                                                 <div
                                                                      class="pgf-attach-main bg-light rounded-2 px-3 py-2 cursor-pointer">
                                                                      <p class="fw-medium text-nowrap file_attachment_div"
                                                                           href="" data-file-name="">New</p>
                                                                 </div>
                                                            </li>
                                                       </ul>
                                                       <ul class="2-div ticket_status_ul">
                                                            <li class="m-2">
                                                                 <div
                                                                      class="pgf-attach-main bg-light rounded-2 px-3 py-2 cursor-pointer">
                                                                      <p class="fw-medium text-nowrap file_attachment_div"
                                                                           href="" data-file-name="">In Progress</p>
                                                                 </div>
                                                            </li>
                                                       </ul>
                                                       <ul class="3-div ticket_status_ul">
                                                            <li class="m-2">
                                                                 <div
                                                                      class="pgf-attach-main bg-light rounded-2 px-3 py-2 cursor-pointer">
                                                                      <p class="fw-medium text-nowrap file_attachment_div"
                                                                           href="" data-file-name="">Closed</p>
                                                                 </div>
                                                            </li>
                                                       </ul> -->